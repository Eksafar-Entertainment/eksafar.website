    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class=" d-none">
                    @for ($n = 0; $n < 3; $n++) <span class="badge rounded-pill bg-info fs-6 fw-normal">Secondary</span>
                        @endfor
                </div>
                        ...
                        <div class="row align-items-end">
                            <div class="col-auto">
                                <div style="margin-top: -40px;">
                                    <img src="{{ url($artist->image != '' ? $artist->image : 'images/singer.png') }}" class="rounded border bg-primary" width="80px" height="80px" style="object-fit: cover" />
                                </div>
                            </div>
                            <div class="col">
        ...
        <div class="col-md-4">
            <div class="sticky-top pt-4">
                <div class="card">
                    ...
                    <div class="soldout" style="background-image:url({{ asset('images/soldout.png') }}); background-size:cover; background-position:center;">
                    </div>
                    @endif

                    ...
                    <div id="event-carousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <div class="card" style="background-image:url('images/test.jpg'); padding-top: 70%; background-size:cover; background-position:center;background-size: 200px 400px;background-repeat: no-repeat;">
                                                ...
                                                <div class="position-absolute bottom-0 start-0 card-body text-light  w-100">
                                                    <h1 class="entry-title">
                                                        ...
                                                        <span class="date-glow">{{ \Carbon\Carbon::parse($event->start_date)->format('d-m-Y') }}</span><br/>

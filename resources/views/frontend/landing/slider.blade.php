		...
		<div class="card-container">
         <div class="card">
             ...
             <div class="back">
                 ...
                 <div class="content">
                     <div class="main">
                         <h4 class="text-center">Guess Where!</h4>
                         <p class="text-center">Heaven in the forest, Jungle, Wildlife, Mountains, River rafting...</p>
...
<div class="card-container">
		 <div class="card">
             ...
             <div class="back">
                 ...
                 <div class="content">
                     <div class="main">
                         <h4 class="text-center">Catch Up, Bangalore</h4>
                         <p class="text-center">Dandiya, Disco, Club Event, Night life, and many more...</p>

                                ...
                                <tr>
                                    <td width="80%">
                                        <h1 class="sm-text-lg all-font-roboto"
                                            ...
                                            Booking Details</h1>
                                        <p class="sm-text-xs" style="margin: 0; color: #a0aec0; font-size: 14px;">Please
                                            enter
                                            the detials below</p>
                                    </td>
                                ...
                                <div class="row col-md-12 col-sm-12">
                                    <div class="col-md-6 col-xs-6" style="font-weight: 600; padding-bottom: 10px;">
                                        <input class="form-control form-control-sm quantity"
                                            style="color: #a0aec0; width:100%;" type="text" name="name"
                                            placeholder="Name" id="name" onfocus="this.placeholder = ''"
                                            onblur="this.placeholder = 'Name'" required>
                                    </div>
                                    <div class="col-md-6 col-xs-6" style="font-weight: 600;">
                                        <input class="form-control form-control-sm quantity"
                                            style="color: #a0aec0; width:100%;" type="number" name="mobile"
                                            placeholder="Mobile No." id="mobile" onfocus="this.placeholder = ''"
                                            onblur="this.placeholder = 'Phone no'" required>
                                    </div>
                                </div>
                                <div class="form-group row col-md-12 col-sm-12">
                                    <div class="col-md-6 col-xs-6" style="font-weight: 600; padding-bottom: 10px;">
                                        <input class="form-control form-control-sm quantity"
                                            style="color: #a0aec0; width:100%;" type="email" name="email"
                                            placeholder="Email address." id="email" onfocus="this.placeholder = ''"
                                        ...
                                        @forelse($event_tickets as $ticket)
                                            <tr class="event-ticket-row" event-ticket-id="{{ $ticket->id }}">
                                                ...
                                                <td width="2%" nowrap class="text-right"
                                                    style="vertical-align:middle; font-family: Menlo, Consolas, monospace; font-weight: 600; color: #cbd5e0; letter-spacing: -1px;">
                                                    ₹{{ $ticket->price }} x </td>

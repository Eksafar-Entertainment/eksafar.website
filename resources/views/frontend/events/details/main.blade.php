...
@include('frontend.events.details.click-line')
      ...
      <div class="col-sm-5" style="position:fixed; top: 15%; right: 0; background-color: rgba(255,255,255,0.9); z-index: 2;">

      <table @if ($mobile) style="margin-top: 15%;" @elseif($desktop) style="width: 90%; float: right;" @endif>

                <td align="left" @if ($desktop) style="padding: 15px; border-radius: 2px; position: absolute; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05); vertical-align: top; z-index: 50;" @endif @if ($mobile) style="border-radius: 2px; position: relative; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05); vertical-align: top; z-index: 50;" @endif bgcolor="#ffffff" valign="top">
                    ...
                    <form action="/payment/checkout" method="post" class="form-inline">
                        ...
                        <table class="table table-sm" style="font-size: 14px; margin-top: 20px;">
                            ...
                            <tr class="event-ticket-row" event-ticket-id="{{ $ticket->id }}">
                                ...
                                <td width="2%" nowrap class="text-right" style="vertical-align:middle; font-family: Menlo, Consolas, monospace; font-weight: 600; color: #063765; letter-spacing: -1px;">
                                    ₹{{ $ticket->price }} x </td>

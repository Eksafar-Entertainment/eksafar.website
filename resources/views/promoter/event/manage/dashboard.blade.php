    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <input class="form-control" type="text" readonly value="{{url('/event/'.$event->slug.'?promoter='.auth("promoter")->user()->id)}}" style="cursor:pointer" onclick="event.target.select();document.execCommand('copy')" />
                </div>
            </div>

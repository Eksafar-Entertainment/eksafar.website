        ...
        <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto">
                            <select class="form-select" name="status">
                                ...
                                <option {{ app('request')->input('status') == 'PENDING' ? 'selected' : '' }}>PENDING
                                </option>
                                <option {{ app('request')->input('status') == 'SUCCESS' ? 'selected' : '' }}>SUCCESS
                                </option>
            ...
            <script>
                ...
                function cancelOrder(order_id) {
                    if (confirm("Are you sure?")) {
                        jQuery.ajax({
                            url: "{{ url('/admin/event/' . $event->id . '/orders/cancel') }}",
                            method: 'post',
                            data: {
                                order_id: order_id
                            },

        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-3 col-6">
                    <div class="position-relative border" style="width:100%; padding-top: 100%; background-size:cover; background-position:center; background-image:url('{{url('/storage/uploads/'.$event_album_image->image)}}')">
                        <form class="position-absolute" style="top: 0; right:0" action="{{url('/admin/event/'.$event->id.'/customize/album-images')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="_method" value="delete" />
                            <input type="hidden" name="event_album_image_id" value="{{$event_album_image->id}}" />
            ...
            <form action="{{url('/admin/event/'.$event->id.'/customize/album-images')}}" id="album_image_form" class="mt-4" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-auto">
